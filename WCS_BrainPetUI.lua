...
local IA_MODES = { "Agresivo", "Defensivo", "Soporte" }
WCS_BrainPetUI.IAMode = 1  -- 1=Agresivo, 2=Defensivo, 3=Soporte
...
function WCS_BrainPetUI:CycleModeIA()
    ...
    -- Aquí se podría integrar con WCS_BrainPetAI para cambiar el comportamiento real
